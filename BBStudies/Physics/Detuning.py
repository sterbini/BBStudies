...
#    Kernel for RDTs
#================================================================================
def Qmk(axb,ayb,dxb,dyb,m,k):   
    return Qmz(axb,dxb,m)*Qmz(ayb,dyb,k)

#================================================================================
#    Path integral for RDTs
#================================================================================
def Dmk(ax,ay,dx_sig,dy_sig,r,m,k):   
    psix=dx_sig/ax/r
    psiy=ay/ax/r
    psiz=dy_sig/ax
    ...
    _i   = 0
    _f   = r*ax
    return 2*integrate.quad(lambda phi: 
                1/phi/_g(phi)*Qmk(  axb=phi,
                                    ayb=phi*psiy/_g(phi),
                                    dxb=phi*psix,
                                    dyb=phi*psiz/_g(phi),
                                    m=m, k=k), _i, _f)[0]
